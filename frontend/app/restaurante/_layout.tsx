...
const Restaurante = () => {
    ...
    return (
        ...
        <View style={styles.resContainer}>
            ...
            <TouchableOpacity onPress={()=>router.push({pathname:`/avaliacoes`,params:{id:restaurante?._id}})}>
        ...
        <View style={styles.itemsContainer}>
                {restaurante && getItensByRestaurante(restaurante._id).map((item) => (
                    ...
                    <TouchableOpacity key={item._id} style={styles.itemCard} onPress={() => router.push({pathname:`/item`,params:{id:item._id}})}>
